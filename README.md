...
```sh
npm install https://github.com/GerHobbelt/jison/archive/0.4.18-170.tar.gz
pushd lib/csound-parser
../../node_modules/jison-lex/cli.js preprocessor.jisonlex --outfile preprocessor.js
../../node_modules/jison-gho/lib/cli.js orchestra.jison orchestra.jisonlex --outfile orchestra-parser.js
popd
```
