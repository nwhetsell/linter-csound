...
../../node_modules/jison-lex/cli.js preprocessor.jisonlex --module-type js --outfile preprocessor.js
../../node_modules/jison-gho/lib/cli.js orchestra.jison orchestra.jisonlex --module-type js --outfile orchestra-parser.js
popd
```
