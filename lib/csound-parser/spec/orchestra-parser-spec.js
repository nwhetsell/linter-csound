...
describe('Csound orchestra parser', () => {
  ...
  beforeEach(() => {
    ...
    parser.yy.pre_parse = yy => Object.assign(yy.lexer.globalSymbolTable.identifiers, SymbolTable.builtInOpcodeSymbolTable.identifiers);
  });
  ...
  it('parses void opcode statement', () => {
    expect(parser.parse('scoreline_i "e"\n')).toEqual(
