...
describe("Csound orchestra parser", () => {
  ...
  it("parses array declarations and member assignments", () => {
    ...
    `)).toEqual(
      new parser.Orchestra([[0, 0], [4, 0]], {children: [
        ...
        new parser.Assignment([[1, 0], [2, 0]], {children: [
          new parser.OutputArgumentList([[1, 0], [1, 10]], {children: [
          ...
          new parser.InputArgumentList([[1, 13], [1, 14]], {children: [
        ...
        new parser.Assignment([[3, 0], [4, 0]], {children: [
          new parser.OutputArgumentList([[3, 0], [3, 26]], {children: [
          ...
          new parser.InputArgumentList([[3, 29], [3, 30]], {children: [
    ...
    expect(parser.messages[0]).toEqual({
      ...
      excerpt: "Multiple ‘[]’ are not needed to declare multidimensional arrays"
    });
  });
  ...
  it("parses array assignments", () => {
    ...
    `)).toEqual(
      new parser.Orchestra([[0, 0], [2, 0]], {children: [
        ...
        new parser.Assignment([[1, 0], [2, 0]], {children: [
          new parser.OutputArgumentList([[1, 0], [1, 8]], {children: [
            new parser.ArrayDeclarator([[1, 0], [1, 8]], {children: [
              new parser.Identifier([[1, 0], [1, 6]], {string: "iArray", type: "i[]"})
            ]})
          ]}),
          new parser.InputArgumentList([[1, 11], [1, 18]], {children: [
    ...
    `)).toEqual(
      new parser.Orchestra([[0, 0], [2, 0]], {children: [
        new parser.Assignment([[0, 0], [1, 0]], {children: [
          new parser.OutputArgumentList([[0, 0], [0, 6]], {children: [
            new parser.Identifier([[0, 0], [0, 2]], {string: "i1", type: "i"}),
            new parser.Identifier([[0, 4], [0, 6]], {string: "i2", type: "i"})
          ]}),
          new parser.InputArgumentList([[0, 9], [0, 13]], {children: [
            new parser.NumberLiteral([[0, 9], [0, 10]], {string: "1"}),
            new parser.NumberLiteral([[0, 12], [0, 13]], {string: "2"})
          ]})
        ]}),
        new parser.Assignment([[1, 0], [2, 0]], {children: [
          new parser.OutputArgumentList([[1, 0], [1, 6]], {children: [
            new parser.Identifier([[1, 0], [1, 2]], {string: "i3", type: "i"}),
            new parser.Identifier([[1, 4], [1, 6]], {string: "i4", type: "i"})
          ]}),
          new parser.InputArgumentList([[1, 9], [1, 10]], {children: [
            new parser.NumberLiteral([[1, 9], [1, 10]], {string: "3"})
          ]})
        ]})
      ]})
    );
    ...
    `)).toEqual(
      new parser.Orchestra([[0, 0], [2, 0]], {children: [
        ...
        new parser.LabeledStatement([[1, 0], [2, 0]], {children: [
          new parser.Label([[1, 0], [2, 0]], {string: "label"})
        ]})
      ]})
    );
    expect(parser.messages.length).toBe(0);
  ...
  it("parses if-goto in instrument", () => {
    expect(parser.parse(dedent`
      label:
    ...
    `)).toEqual(
      new parser.Orchestra([[0, 0], [7, 0]], {children: [
        new parser.LabeledStatement([[0, 0], [2, 0]], {children: [
          new parser.Label([[0, 0], [1, 0]], {string: "label"}),
          new parser.Empty([[1, 0], [2, 0]])
        ]}),
        new parser.Instrument([[2, 0], [7, 0]], {children: [
          new parser.InstrumentNumberAndNameList([[2, 6], [2, 7]], {children: [
            new parser.NumberLiteral([[2, 6], [2, 7]], {string: "1"})
          ]}),
          new parser.If([[3, 2], [4, 0]], {children: [
            new parser.BinaryOperation([[3, 5], [3, 11]], {children: [
              new parser.NumberLiteral([[3, 5], [3, 6]], {string: "1"}),
              new parser.Equal([[3, 7], [3, 9]], {string: "=="}),
              new parser.NumberLiteral([[3, 10], [3, 11]], {string: "1"})
            ]}),
            new parser.Goto([[3, 12], [4, 0]], {children: [
              new parser.Identifier([[3, 17], [3, 22]], {string: "label"})
            ]})
          ]}),
          new parser.LabeledStatement([[4, 0], [6, 0]], {children: [
            new parser.Label([[4, 0], [5, 0]], {string: "label"}),
            new parser.Empty([[5, 0], [6, 0]])
          ]})
        ]})
      ]})
    );
  ...
  it("parses orchestra", () => {
    ...
    `)).toEqual(
      new parser.Orchestra([[0, 0], [5, 0]], {children: [
        new parser.Assignment([[0, 0], [1, 0]], {children: [
          new parser.OutputArgumentList([[0, 0], [0, 5]], {children: [
            new parser.Identifier([[0, 0], [0, 5]], {string: "0dbfs", type: "i"})
          ]}),
          new parser.InputArgumentList([[0, 8], [0, 9]], {children: [
            new parser.NumberLiteral([[0, 8], [0, 9]], {string: "1"})
          ]})
        ]}),
  ...
  it("analyzes opcode output that does not begin with type characters", () => {
    ...
    expect(parser.messages[1]).toEqual({
      ...
      excerpt: "Types of output arguments do not match type signatures of opcode ‘init’"
    });
  });
