...
var CsoundDocumentProcessor = function() {
  /**
   * See also:
...
EOF: 1,
    ...
    performAction: function lexer__performAction(yy, yyrulenumber, YY_START) {
      ...
      case 3:
        ...
        if (this.synthesizerElementName !== yy_.yytext.substring(2, yy_.yyleng - 1)) {
          this.messages.push({
            severity: 'warning',
            ...
            excerpt: `End tag ${yy_.yytext} does not match start tag <${this.synthesizerElementName}>`,
...
if (typeof require !== 'undefined' && typeof exports !== 'undefined') {
  exports.lexer = CsoundDocumentProcessor;

  exports.lex = function() {
    return CsoundDocumentProcessor.lex.apply(lexer, arguments);
  };
}
