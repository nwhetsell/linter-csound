...
symbols_: {
  ...
  "instrument": 100,
  "instrument_number_and_name_list": 99,
  "instrument_number_or_name": 97,
  "instrument_numbers_and_names": 98,
  ...
  "opcode": 7,
  "opcode_definition": 107,
  "opcode_input_types": 105,
  "opcode_inputs": 19,
  "opcode_output_types": 103,
  "opcode_outputs": 71,
  "opcode_type_annotation": 20,
  "orchestra": 111,
  "orchestra_statement": 109,
  "orchestra_statements": 110,
...
terminals_: {
  ...
  101: "INSTR",
  102: "ENDIN",
  104: "OPCODE_OUTPUT_TYPES",
  106: "OPCODE_INPUT_TYPES",
  108: "ENDOP",
  124: "|",
  126: "~"
},
...
case 16:
    ...
    this.$ = new OpcodeInvocation(this._$, {children: [$$[$0 - 3], $$[$0 - 1]]});
    break;

case 17:
    /*! Production::    postfix_expression : opcode ':' opcode_type_annotation '(' opcode_inputs ')' */
    this.$ = new OpcodeInvocation(this._$, {children: [$$[$0 - 5], $$[$0 - 1]], outputType: $$[$0 - 3]});
    break;
...
case 75:
    /*! Production::    assignment_statement : opcode_outputs opcode opcode_inputs NEWLINE */
    this.$ = new OpcodeStatement(this._$, {children: [
      new ArgumentList(_$[$0 - 3], {children: $$[$0 - 3]}),
      $$[$0 - 2],
...
case 76:
    /*! Production::    assignment_statement : opcode_outputs opcode NEWLINE */
    this.$ = new OpcodeStatement(this._$, {children: [
...
/*! Rule::       [^,] */ 
  ...
  throw new CsoundLexerError({
    type: 'Error',
    text: 'Expected comma after opcode output name',
    range: this.rangeFromPosition(yy_.yylloc.first_line, yy_.yylloc.first_column)
  });
