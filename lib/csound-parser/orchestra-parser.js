...
case 4:
    ...
    this._$ = {first_line: yylstack[yysp - (yyrulelength - 1)].first_line, first_column: yylstack[yysp - (yyrulelength - 1)].first_column, last_line: yylstack[yysp].last_line, last_column: yylstack[yysp].last_column}; this.$ = new Identifier(this._$, {string: yyvstack[yysp]});
    break;
...
case 7:
    ...
    this._$ = {first_line: yylstack[yysp - (yyrulelength - 1)].first_line, first_column: yylstack[yysp - (yyrulelength - 1)].first_column, last_line: yylstack[yysp].last_line, last_column: yylstack[yysp].last_column};
...
case 20:
    ...
    this._$ = {first_line: yylstack[yysp - (yyrulelength - 1)].first_line, first_column: yylstack[yysp - (yyrulelength - 1)].first_column, last_line: yylstack[yysp].last_line, last_column: yylstack[yysp].last_column}; this.$ = new UnaryPlus(this._$);
    break;

case 21:
    /*! Production::    unary_operator : "-" */
    this._$ = {first_line: yylstack[yysp - (yyrulelength - 1)].first_line, first_column: yylstack[yysp - (yyrulelength - 1)].first_column, last_line: yylstack[yysp].last_line, last_column: yylstack[yysp].last_column}; this.$ = new UnaryMinus(this._$);
    break;

case 22:
    /*! Production::    unary_operator : "~" */
    this._$ = {first_line: yylstack[yysp - (yyrulelength - 1)].first_line, first_column: yylstack[yysp - (yyrulelength - 1)].first_column, last_line: yylstack[yysp].last_line, last_column: yylstack[yysp].last_column}; this.$ = new BitwiseComplement(this._$);
    break;

case 23:
    /*! Production::    unary_operator : "!" */
    this._$ = {first_line: yylstack[yysp - (yyrulelength - 1)].first_line, first_column: yylstack[yysp - (yyrulelength - 1)].first_column, last_line: yylstack[yysp].last_line, last_column: yylstack[yysp].last_column}; this.$ = new Not(this._$);
    break;
...
case 66:
    ...
    this._$ = {first_line: yylstack[yysp - (yyrulelength - 1)].first_line, first_column: yylstack[yysp - (yyrulelength - 1)].first_column, last_line: yylstack[yysp].last_line, last_column: yylstack[yysp].last_column}; this.$ = new Multiplication(this._$);
    break;
...
case 67:
    /*! Production::    compound_assignment_operator : "/=" */
    this._$ = {first_line: yylstack[yysp - (yyrulelength - 1)].first_line, first_column: yylstack[yysp - (yyrulelength - 1)].first_column, last_line: yylstack[yysp].last_line, last_column: yylstack[yysp].last_column}; this.$ = new Division(this._$);
    break;

case 28:
    /*! Production::    multiplicative_operator : "^" */
    this._$ = {first_line: yylstack[yysp - (yyrulelength - 1)].first_line, first_column: yylstack[yysp - (yyrulelength - 1)].first_column, last_line: yylstack[yysp].last_line, last_column: yylstack[yysp].last_column}; this.$ = new Power(this._$);
    break;

case 29:
    /*! Production::    multiplicative_operator : "%" */
    this._$ = {first_line: yylstack[yysp - (yyrulelength - 1)].first_line, first_column: yylstack[yysp - (yyrulelength - 1)].first_column, last_line: yylstack[yysp].last_line, last_column: yylstack[yysp].last_column}; this.$ = new Modulus(this._$);
    break;
...
case 64:
    /*! Production::    compound_assignment_operator : "+=" */
    this._$ = {first_line: yylstack[yysp - (yyrulelength - 1)].first_line, first_column: yylstack[yysp - (yyrulelength - 1)].first_column, last_line: yylstack[yysp].last_line, last_column: yylstack[yysp].last_column}; this.$ = new Plus(this._$);
    break;
...
case 65:
    /*! Production::    compound_assignment_operator : "-=" */
    this._$ = {first_line: yylstack[yysp - (yyrulelength - 1)].first_line, first_column: yylstack[yysp - (yyrulelength - 1)].first_column, last_line: yylstack[yysp].last_line, last_column: yylstack[yysp].last_column}; this.$ = new Minus(this._$);
    break;

case 36:
    /*! Production::    shift_operator : "<<" */
    this._$ = {first_line: yylstack[yysp - (yyrulelength - 1)].first_line, first_column: yylstack[yysp - (yyrulelength - 1)].first_column, last_line: yylstack[yysp].last_line, last_column: yylstack[yysp].last_column}; this.$ = new LeftShift(this._$);
    break;

case 37:
    /*! Production::    shift_operator : ">>" */
    this._$ = {first_line: yylstack[yysp - (yyrulelength - 1)].first_line, first_column: yylstack[yysp - (yyrulelength - 1)].first_column, last_line: yylstack[yysp].last_line, last_column: yylstack[yysp].last_column}; this.$ = new RightShift(this._$);
    break;

case 40:
    /*! Production::    relational_operator : "<" */
    this._$ = {first_line: yylstack[yysp - (yyrulelength - 1)].first_line, first_column: yylstack[yysp - (yyrulelength - 1)].first_column, last_line: yylstack[yysp].last_line, last_column: yylstack[yysp].last_column}; this.$ = new LessThan(this._$);
    break;

case 41:
    /*! Production::    relational_operator : ">" */
    this._$ = {first_line: yylstack[yysp - (yyrulelength - 1)].first_line, first_column: yylstack[yysp - (yyrulelength - 1)].first_column, last_line: yylstack[yysp].last_line, last_column: yylstack[yysp].last_column}; this.$ = new GreaterThan(this._$);
    break;

case 42:
    /*! Production::    relational_operator : "<=" */
    this._$ = {first_line: yylstack[yysp - (yyrulelength - 1)].first_line, first_column: yylstack[yysp - (yyrulelength - 1)].first_column, last_line: yylstack[yysp].last_line, last_column: yylstack[yysp].last_column}; this.$ = new LessThanOrEqual(this._$);
    break;

case 43:
    /*! Production::    relational_operator : ">=" */
    this._$ = {first_line: yylstack[yysp - (yyrulelength - 1)].first_line, first_column: yylstack[yysp - (yyrulelength - 1)].first_column, last_line: yylstack[yysp].last_line, last_column: yylstack[yysp].last_column}; this.$ = new GreaterThanOrEqual(this._$);
    break;

case 46:
    /*! Production::    equality_operator : "==" */
    this._$ = {first_line: yylstack[yysp - (yyrulelength - 1)].first_line, first_column: yylstack[yysp - (yyrulelength - 1)].first_column, last_line: yylstack[yysp].last_line, last_column: yylstack[yysp].last_column}; this.$ = new Equal(this._$);
    break;

case 47:
    /*! Production::    equality_operator : "!=" */
    this._$ = {first_line: yylstack[yysp - (yyrulelength - 1)].first_line, first_column: yylstack[yysp - (yyrulelength - 1)].first_column, last_line: yylstack[yysp].last_line, last_column: yylstack[yysp].last_column}; this.$ = new NotEqual(this._$);
    break;
  ...
  var lexer = {
    ...
    */
    ...
    rules: [
      ...
      /* 78: */  /^(?:(\d+))/,
      /* 79: */  /^(?:(\d+\.?\d*(?:(?:[Ee])(?:[-+]?(?:\d+)))?|\.\d+(?:(?:[Ee])(?:[-+]?(?:\d+)))?))/,
      /* 80: */  /^(?:0dbfs|A4|k(?:r|smps)|nchnls(?:_i)?|sr)/,
      /* 81: */  /^(?:([^\W\d]\w*))/,
      /* 82: */  /^(?:[ak])/,
      /* 83: */  /^(?:.|\n)/,
      /* 84: */  /^(?:"(\\.|[^"])*"|\{\{(?:[^}]|\}[^}])*\}\})/,
