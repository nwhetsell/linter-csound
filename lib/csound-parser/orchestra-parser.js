...
case 62:
    ...
    this.$ = new LabeledStatement(this._$, {children: [new Label(yylstack[yysp - 1], {string: yyvstack[yysp - 1].slice(0, -2).trim()}), yyvstack[yysp]]});
    break;
...
case 63:
    ...
    this.$ = new LabeledStatement(this._$, {children: [new Label(yylstack[yysp - 1], {string: yyvstack[yysp - 1].slice(0, -2).trim()})]});
    break;
