...
case 84:
    ...
    parser.addError({
      ...
      range: parser.lexer.rangeFromPosition(yylstack[yysp - 2].last_line, yylstack[yysp - 2].last_column)
    });
    break;
...
case 105:
    ...
    parser.addError({
      ...
      range: parser.lexer.rangeFromPosition(yylstack[yysp].first_line, yylstack[yysp].first_column)
    });
    break;
