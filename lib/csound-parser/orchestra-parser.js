...
case 84:
    ...
    parser.addError({
      severity: 'error',
      location: {
        position: parser.lexer.rangeFromPosition(yylstack[$0 - 2].last_line, yylstack[$0 - 2].last_column)
      },
...
case 105:
    ...
    parser.addError({
      severity: 'error',
      location: {
        position: parser.lexer.rangeFromPosition(yylstack[$0].first_line, yylstack[$0].first_column)
      },
