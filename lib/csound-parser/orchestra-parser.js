...
case 17:
    ...
    this.$ = new OpcodeExpression(this._$, {outputTypeAnnotation: $$[$0 - 3], children: [
      $$[$0 - 4],
      new ArgumentList(_$[$0 - 1], {children: $$[$0 - 1]})],
    });
    break;
...
case 115:
    ...
    this.$ = new OpcodeOutputTypeSignature(this._$, {string: $$[$0]});
    break;

case 116:
    /*! Production::    opcode_input_types : OPCODE_INPUT_TYPES */
    this.$ = new OpcodeInputTypeSignature(this._$, {string: $$[$0]});
    break;
