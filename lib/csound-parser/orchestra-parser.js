      ...
      switch (yyrulenumber) {
        ...
        case 44:
          ...
          this.messages.push({
            ...
            excerpt: `${this.quote(yy_.yytext)} instead of ${this.quote(
              "endif"
            )} used to end if statement`
          });
          return 52;
          break;
        case 49:
        ...
        case 53:
          ...
          if (label) {
            this.messages.push({
              ...
              location: {
                position: this.sourceMap.sourceRange([
                  ...
                  [
                    yy_.yylloc.first_line - 1,
                    yy_.yylloc.first_column + labelName.length
                  ]
                ])
              },
            ...
            this.globalSymbolTable.addLabel(
              labelName,
              this.sourceMap.sourceRange([
                [yy_.yylloc.first_line - 1, yy_.yylloc.first_column],
                [
                  yy_.yylloc.first_line - 1,
                  yy_.yylloc.first_column + labelName.length
        ...
        case 59:
          ...
          throw new CsoundLexerError({
            severity: "error",
            location: {
              position: this.rangeFromPosition(
        ...
        case 75:
          ...
          this.globalSymbolTable.addOpcode(this.opcodeName, {
            [yy_.yytext === "0" ? "" : yy_.yytext]: [
              this.opcodeOutputTypeSignature
            ]
          });
          return 60;
          break;
        ...
        case 81:
          ...
          if (symbol && symbol.kind === "opcode") {
            ...
            const character = this.input();
            if (character === ":") this.begin("opcode_output_type_annotation");
            else this.unput(character);
            return 26;
          }
        ...
        case 83:
          ...
          throw new CsoundLexerError({
            ...
            excerpt: `Expected output type (${this.quote("a")} or ${this.quote(
              "k"
            )})`
          });
          break;
