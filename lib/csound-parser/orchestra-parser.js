...
case 59:
    ...
    this.$ = new ConditionalExpression(this._$, {children: [yyvstack[yysp - 4], yyvstack[yysp - 3], yyvstack[yysp - 2]]});
    break;
...
case 105:
    ...
    parser.addError({
      severity: 'error',
      location: {
        position: parser.lexer.rangeFromPosition(yylstack[yysp].first_line, yylstack[yysp].first_column)
      },
...
case 114:
    ...
    yyvstack[yysp - 2].splice(0, 0, yyvstack[yysp - 4]);
    this.$ = new Instrument(this._$, {children: yyvstack[yysp - 2]});
    break;
...
case 118:
    ...
    yyvstack[yysp - 2].splice(0, 0, yyvstack[yysp - 8], yyvstack[yysp - 6], yyvstack[yysp - 4]);
    this.$ = new Opcode(this._$, {children: yyvstack[yysp - 2]});
    break;
