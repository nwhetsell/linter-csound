...
case 16:
    ...
    this.$ = new OpcodeInvocation(this._$, {children: [$$[$0 - 3], new ArgumentList(_$[$0 - 1], {children: $$[$0 - 1]})]});
    break;

case 17:
    /*! Production::    postfix_expression : opcode OPCODE_OUTPUT_TYPE_ANNOTATION '(' opcode_inputs ')' */
    this.$ = new OpcodeInvocation(this._$, {
      children: [$$[$0 - 4], new ArgumentList(_$[$0 - 1], {children: $$[$0 - 1]})],
      outputType: $$[$0 - 3]
    });
    break;
