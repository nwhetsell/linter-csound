/* lexer generated by jison-lex 0.3.4-173 */
/*
...
break;
case 23 :
/*! Conditions:: macro_parameter_value_quoted_string macro_parameter_value_braced_string macro_parameter_value_parenthetical */
/*! Rule::       \) */
  ...
  this.messages.push({
    type: 'Error',
    filePath: this.filePath,
    text: `${this.quote(yy_.yytext)} must be replaced with ${this.quote('\\)')}`,
    range: fix.range,
    fix: fix
  });
...
/*! Rule::       \( */
 this.macroParameterValue += yy_.yytext; this.begin(YY_START);
break;
case 28 :
/*! Conditions:: macro_parameter_value_parenthetical */
/*! Rule::       \\\) */
 this.macroParameterValue += ')';    this.popState();
break;
case 29 :
...
if (typeof require !== 'undefined' && typeof exports !== 'undefined') {
  exports.lexer = preprocessor;
  exports.lex = function () {
    return preprocessor.lex.apply(lexer, arguments);
  };
}
