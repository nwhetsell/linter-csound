...
/*! Rule::       {macro_use}\( */ 
  ...
  this.macroUse = new MacroUseElement(yy_.yytext, this.getMacro(yy_.yytext.substring(1, i)));
...
/*! Rule::       \d+ */ 
  ...
  this.popState();
  this.addText(Math.pow(2, Math.ceil(Math.log2(parseInt(yy_.yytext, 10) + 1))).toString());
...
/*! Rule::       \d+ */ 
  ...
  this.popState();
  const number = parseInt(yy_.yytext, 10);
...
break;
case 64 : 
/*! Conditions:: INITIAL ifdef_true else_true */ 
/*! Rule::       {newline} */ 
 this.addNewline(); 
break;
case 65 : 
