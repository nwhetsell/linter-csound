...
EOF: 1,
    ...
    conditions: {
      ...
      'define_directive': {
        rules: [1, 6, 8, 12, 32, 33, 50, 52, 61, 62, 63, 69, 73, 74, 75, 82, 98, 99],
        inclusive: true
      },

      'macro_parameter_name_list': {
        rules: [34, 35, 36, 37, 38],
        inclusive: false
      },
      ...
      'before_macro_body': {
        rules: [1, 6, 8, 12, 32, 43, 44, 45, 50, 52, 61, 62, 63, 69, 82, 98, 99],
        inclusive: true
      },
      ...
      'undef_directive': {
        rules: [1, 6, 8, 12, 32, 50, 51, 52, 61, 62, 63, 69, 73, 74, 75, 82, 98, 99],
        inclusive: true
      },

      'ifdef_directive': {
        rules: [1, 6, 8, 12, 32, 50, 52, 53, 61, 62, 63, 69, 73, 74, 75, 82, 98, 99],
        inclusive: true
      },

      'ifndef_directive': {
        rules: [1, 6, 8, 12, 32, 50, 52, 54, 61, 62, 63, 69, 73, 74, 75, 82, 98, 99],
        inclusive: true
      },

      'ifdef_true': {
        rules: [1, 6, 8, 12, 32, 50, 52, 55, 57, 60, 61, 62, 63, 69, 82, 98, 99],
        inclusive: true
      },
      ...
      'else_true': {
        rules: [1, 6, 8, 12, 32, 50, 52, 55, 56, 60, 61, 62, 63, 69, 82, 98, 99],
        inclusive: true
      },
      ...
      'INITIAL': {
        rules: [0, 1, 6, 8, 12, 16, 31, 32, 50, 52, 61, 62, 63, 69, 76, 82, 98, 99],
        inclusive: true
      }
    }
  };
