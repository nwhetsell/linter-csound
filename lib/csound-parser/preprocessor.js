...
EOF: 1,
    ...
    performAction: function lexer__performAction(yy, yyrulenumber, YY_START) {
      ...
      switch (yyrulenumber) {
      case 0:
        /*! Conditions:: INITIAL quoted_string macro_parameter_value_quoted_string includestr_directive_quoted_string */
      ...
      case 11:
        /*! Conditions:: quoted_string macro_parameter_value_quoted_string includestr_directive_quoted_string */
        /*! Rule::       {newline}|$ */
        this.messages.push({
          severity: 'error',
      ...
      case 30:
        /*! Conditions:: macro_parameter_value macro_parameter_value_braced_string macro_parameter_value_parenthetical */
        /*! Rule::       .|{newline} */
        this.macroParameterValue += yy_.yytext;
      ...
      case 65:
        /*! Conditions:: includestr_directive */
        /*! Rule::       [ \t] */
        // Do nothing
        break;
      ...
      case 68:
        /*! Conditions:: includestr_directive_quoted_string */
        /*! Rule::       " */
      ...
      case 69:
        /*! Conditions:: includestr_directive_quoted_string */
        /*! Rule::       . */
        this.includestrFilePath += yy_.yytext;
      ...
      case 72:
        ...
        /*! Rule::       [^ \t] */
        {
          const includeFilePathStartRange = this.rangeFromPosition(yy_.yylloc.first_line, yy_.yylloc.first_column);
      ...
      case 73:
        /*! Conditions:: include_directive includestr_directive */
        /*! Rule::       {newline}|$ */
        throw new CsoundPreprocessorError({
          severity: 'error',
    ...
    conditions: {
      ...
      'define_directive': {
        rules: [1, 6, 8, 12, 33, 34, 51, 53, 62, 63, 64, 70, 74, 75, 76, 83, 99, 100],
        inclusive: true
      },

      'macro_parameter_name_list': {
        rules: [35, 36, 37, 38, 39],
        inclusive: false
      },
      ...
      'before_macro_body': {
        rules: [1, 6, 8, 12, 33, 44, 45, 46, 51, 53, 62, 63, 64, 70, 83, 99, 100],
        inclusive: true
      },
      ...
      'undef_directive': {
        rules: [1, 6, 8, 12, 33, 51, 52, 53, 62, 63, 64, 70, 74, 75, 76, 83, 99, 100],
        inclusive: true
      },

      'ifdef_directive': {
        rules: [1, 6, 8, 12, 33, 51, 53, 54, 62, 63, 64, 70, 74, 75, 76, 83, 99, 100],
        inclusive: true
      },

      'ifndef_directive': {
        rules: [1, 6, 8, 12, 33, 51, 53, 55, 62, 63, 64, 70, 74, 75, 76, 83, 99, 100],
        inclusive: true
      },

      'ifdef_true': {
        rules: [1, 6, 8, 12, 33, 51, 53, 56, 58, 61, 62, 63, 64, 70, 83, 99, 100],
        inclusive: true
      },
      ...
      'else_true': {
        rules: [1, 6, 8, 12, 33, 51, 53, 56, 57, 61, 62, 63, 64, 70, 83, 99, 100],
        inclusive: true
      },
      ...
      'INITIAL': {
        rules: [0, 1, 6, 8, 12, 17, 32, 33, 51, 53, 62, 63, 64, 70, 77, 83, 99, 100],
        inclusive: true
      }
    }
  };
